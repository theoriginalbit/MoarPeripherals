...
public class GuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (gui != null) {
            switch (gui) {
                case CRAFTER:
                    return new ContainerCrafter(player, (TileComputerCrafter) world.getBlockTileEntity(x, y, z));
                case PRINTER:
                    return new ContainerPrinter(player, (TilePrinter) world.getBlockTileEntity(x, y, z));
            }
        }
        return null;
    }
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (gui != null) {
            switch (gui) {
                ...
                case CRAFTER:
                    return new GuiCrafter(new ContainerCrafter(player, (TileComputerCrafter) world.getBlockTileEntity(x, y, z)));
                case PRINTER:
                    return new GuiPrinter(new ContainerPrinter(player, (TilePrinter) world.getBlockTileEntity(x, y, z)));
            }
        }
        return null;
    }
