...
public class UpgradeShears extends UpgradeTool {
    private static final ImmutableList<Block> SHEAR_DIG = ImmutableList.of(Block.cloth, Block.web);

    public UpgradeShears() {
        super(ConfigHandler.upgradeIdShears, Constants.UPGRADE.SHEARS.getLocalised(), new ItemStack(Item.shears));
    }

    @Override
    public Icon getIcon(ITurtleAccess turtle, TurtleSide side) {
        return Item.shears.getIconFromDamage(0);
    }
