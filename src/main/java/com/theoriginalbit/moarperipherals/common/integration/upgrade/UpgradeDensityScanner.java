...
import com.theoriginalbit.moarperipherals.common.integration.upgrade.peripheral.PeripheralDensityScanner;
...
public class UpgradeDensityScanner extends UpgradePeripheral implements IUpgradeToolIcon {
    ...
    public UpgradeDensityScanner() {
        super(ConfigData.upgradeIdOreScanner, Constants.UPGRADE.DENSITYSCANNER.getLocalised(), scanner);
    }
