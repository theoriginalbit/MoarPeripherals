...
public class BlockMiniAntenna extends BlockMoarP {
    public BlockMiniAntenna() {
        super(ConfigHandler.blockIdMiniAntenna, "miniAntenna");
    ...
    public boolean canPlaceBlockAt(World world, int x, int y, int z) {
        return y < world.getHeight() - 1 && world.doesBlockHaveSolidTopSurface(x, y - 1, z) && super.canPlaceBlockAt(world, x, y, z) && super.canPlaceBlockAt(world, x, y + 1, z);
    }
