...
public class ModelSonic10 extends ModelBase {
    ...
    public ModelSonic10() {
        ...
        stalkFrame1 = new ModelRenderer(this, 101, 12);
        stalkFrame1.addBox(0F, 0F, 0F, 6, 13, 0);
        stalkFrame1.setRotationPoint(-3F, -37F, 3F);
        stalkFrame1.setTextureSize(128, 64);
        stalkFrame1.mirror = true;
        setRotation(stalkFrame1, 0F, 0F, 0F);
        stalkFrame2 = new ModelRenderer(this, 101, 12);
        stalkFrame2.addBox(0F, 0F, 0F, 6, 13, 0);
        stalkFrame2.setRotationPoint(-3F, -37F, -3F);
        stalkFrame2.setTextureSize(128, 64);
        stalkFrame2.mirror = true;
        setRotation(stalkFrame2, 0F, -1.570796F, 0F);
        stalkFrame3 = new ModelRenderer(this, 88, 9);
        stalkFrame3.addBox(0F, 0F, 0F, 0, 13, 6);
        stalkFrame3.setRotationPoint(3F, -37F, -3F);
        stalkFrame3.setTextureSize(128, 64);
        stalkFrame3.mirror = true;
        setRotation(stalkFrame3, 0F, -1.570796F, 0F);
        stalkFrame4 = new ModelRenderer(this, 88, 9);
        stalkFrame4.addBox(0F, 0F, 0F, 0, 13, 6);
        stalkFrame4.setRotationPoint(3F, -37F, -3F);
