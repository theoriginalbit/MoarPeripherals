...
import com.theoriginalbit.minecraft.moarperipherals.common.block.abstracts.BlockPairable;
import com.theoriginalbit.minecraft.moarperipherals.client.gui.GuiType;
...
public class BlockKeyboard extends BlockPairable {
    ...
    public BlockKeyboard() {
        super(ConfigHandler.blockIdKeyboard, Material.iron, "keyboard");
