...
import com.moarperipherals.block.*;
import com.moarperipherals.config.ConfigData;
import com.moarperipherals.item.ItemBlockPaired;
import com.moarperipherals.tile.*;
    ...
    public static void addRecipes() {
        ...
        if (ConfigData.enableAntenna) {
            ...
            GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(blockAntennaController),
                    ...
                    'I', "ingotIron",
                    'C', ComputerCraft.cc_cable,
                    'W', ComputerCraft.cc_wiredModem,
                    'P', ComputerCraft.cc_blockComputer
            ));
        }
